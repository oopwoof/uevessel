...
### 前提 2 · UE5 Interchange API 稳定(5.5+)

旧的 asset import 系统(FactoryAssetImport)碎片化严重,没法在"批量资产导入"这个场景里做出流畅体验。UE 5.5 起的 Interchange API 默认启用且行为稳定,让 Asset Pipeline Agent 成为可能。
