...
{
	// User-edited steps never reach this builder — the FSM short-circuits
	// them in EnterJudgeReview with a deterministic Approve verdict (see
	// VesselSessionMachine.cpp, the `bUserEditedArgs` early return). That
	// single bypass keeps this prompt uniform across every path that
	// actually calls an LLM Judge.
